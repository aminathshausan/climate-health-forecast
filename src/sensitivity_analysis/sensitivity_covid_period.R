...
####################################
#this program performs sensitivity analysis of covid period
## time frame is months starting from  January 2008 to Dec 2019  
###############################
...
####################################
## Structure data to for modelling
#####################################
...
## select only pre-covid data (2008 to 2019)
data.model <- data.model %>%
    filter(year <= 2019)
print(unique(data.model$year))
